...
const newQuotes = [
  {
    quote: "Huston, we have a problem.",
    movie: "Apollo 13",
    year: 1995,
    rating: "PG-13"
  }, {
    quote: "Gentlemen, you can't fight here! This is the war room!",
...
d3.select('#remove-r')
  .on('click', () => {
    const selectedQuotes = quotes.filter((v) => v.rating !== 'R');

    d3.selectAll('#quotes li')
      .data(selectedQuotes, (d) => d.quote)
      .exit()
      .remove();
  });
